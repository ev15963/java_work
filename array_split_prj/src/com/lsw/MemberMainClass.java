...
public class MemberMainClass {
	...
	public static void main(String[] args) {
		...
		/*
		 * //for(int i=0;i<member.length) String[] m97=member[97].split(",");
		 * System.out.println(m97[3]); String v=m97[3]; //"44" =>44 int n =
		 * Integer.parseInt(v);//문자열 숫자를 숫자로 반환 String v2=m97[5];
		 * System.out.println(m97[5]); System.out.println(m97[5].substring(0,2));
		 */
